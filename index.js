...
const initializeBot = async () => {
    console.clear();
    console.log(chalk.cyan(figlet.textSync('𝗫 𝗥𝗢𝗠𝗘𝗢 𝗠𝗗 🍒💋', {
        font: 'Standard',
    ...
    console.log(chalk.green('   𝗫 𝗥𝗢𝗠𝗘𝗢 𝗠𝗗 🍒💋 𝐩𝐚𝐢𝐫𝐢𝐧𝐠 𝐬𝐲𝐬𝐭𝐞𝐦       '));
    console.log(chalk.yellow('═══════════════════════════════════════════════\n'));
...
function launchBot() {
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('✅𝗫 𝗥𝗢𝗠𝗘𝗢 𝗠𝗗 🍒💋 bot loaded successfully!'));
        } catch (error) {
    ...
    console.log(chalk.bold.white('𝗫 𝗥𝗢𝗠𝗘𝗢 𝗠𝗗 🍒💋 BOT INITIALIZATION SUMMARY          '));
    console.log(chalk.cyan('═══════════════════════════════════════════════'));
    console.log(telegramLoaded ? chalk.green('✅𝗫 𝗥𝗢𝗠𝗘𝗢 𝗠𝗗 🍒💋 тɛℓɛɢяαм вσт: Active') : chalk.red('❌𝐒ＨＡＤＯＷ тɛℓɛɢяαм вσт : Inactive'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ 𝗫 𝗥𝗢𝗠𝗘𝗢 𝗠𝗗 🍒💋 system is ready and running!\n'));
    }
